...
/** Build a quadrangle defined by three points p00, p10, p01. The last point is defined as p11=p10+p01-p00 */
mesh mesh_primitive_quad(const vec3& p00={0,0,0}, const vec3& p10={1,0,0}, const vec3& p01={0,1,0});
